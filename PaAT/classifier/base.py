...
class BASE(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.I_way = nn.Parameter(torch.eye(self.args.way, dtype=torch.float), requires_grad=True)
    ...
    def reidx_y(self, YS, YQ):
        ...
        Y_new = torch.arange(start=0, end=self.args.way, dtype=unique1.dtype, device=unique1.device)
